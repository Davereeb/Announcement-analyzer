...
> **定义**：衡量公告文本信息的**具体程度与精确程度**（Information Granularity），而非信息占比。
>
> 评分从五个维度累加：数值具体性、时间精度、主体明确性、因果链完整性、可证伪性。
> 仅对 `is_valuable = 有` 的公告打分，无价值公告输出 null。

| Excel颜色 | 范围 | 等级 | 典型示例 |
|-----------|------|------|---------|
| 🟢 深绿 | 81-100 | 极细 | "Q3净利润12.3亿，同比+28%，超预期4.2%，因28nm产能利用率升至92%" |
| 🟢 浅绿 | 61-80 | 细 | "Q3净利润12.3亿，同比+28%，因产品均价提升15%" |
| 🔵 浅蓝 | 41-60 | 中 | "Q3净利润同比增长约30%，受益于产品涨价" |
| 🟡 浅黄 | 21-40 | 粗 | "净利润同比增长，营收超预期" |
| ⬜ 浅灰 | 0-20 | 极粗 | "公司业绩表现良好" / 纯定性描述 |

> 💡 **推荐筛选组合**：`is_valuable = 有` + `granularity ≥ 61`，快速定位含具体数据的高价值公告
